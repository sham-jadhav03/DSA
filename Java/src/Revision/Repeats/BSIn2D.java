...
public class BSIn2D {
    ...
    // search in row provided and col provided
    ...
    static int[] search(int[][] matrix, int target){
        int r = matrix.length;
        int c = matrix[0].length; //be cautions, the matrix may be empty
      ...
      //run the loop till 2 rows are remaining
        while (rStart < (rEnd -1)) { // while this is true it have more that row 2
